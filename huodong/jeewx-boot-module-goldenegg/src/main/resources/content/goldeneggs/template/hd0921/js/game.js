...
// symbols:
    ...
    (lib.eggs = function (mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off: false}, 0).to({
            regX: 127.9,
            rotation: 15,
            x: 144
        }, 11, cjs.Ease.get(0.5)).to({
            regY: 100.7,
            rotation: -15,
            y: -75.2
        }, 10, cjs.Ease.get(0.8)).to({alpha: 0}, 11).to({_off: true}, 1).wait(20));
